...
//		sourceDataLineThread = new SourceDataLineThread(serverPort, serverDatagramSocket, sourceDataLine, mixerWrapper);
...
//		sourceDataLineThread = new SourceDataLineThread(serverPort, null, sourceDataLine, mixerWrapper);
//		sourceDataLineThread.initialize();
//		verify(sourceDataLine, never()).start();
	}
...
//
//		sourceDataLineThread = new SourceDataLineThread(serverPort, serverDatagramSocket, null, mixerWrapper);
//		sourceDataLineThread.initialize();
//		verify(serverDatagramSocket, times(1)).close();
...
//		sourceDataLineThread = new SourceDataLineThread(serverPort, null, sourceDataLine, null);
//
...
//		doNothing().when(serverDatagramSocket).close();
//		sourceDataLineThread = new SourceDataLineThread(serverPort, serverDatagramSocket, sourceDataLine, null);
